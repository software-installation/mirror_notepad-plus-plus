# 仓库说明：mirror_notepad-plus-plus

## 🔍 仓库性质
本仓库是 **[notepad-plus-plus/notepad-plus-plus](https://github.com/notepad-plus-plus/notepad-plus-plus)** 的镜像备份仓库，用于同步源仓库的所有 Release 内容（包括安装包、资源文件及源代码），仅作为数据备份和访问保障。
